...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function searchEvents(keyword) {
        const url = "/admin/searchEvent?keyword=" + encodeURIComponent(keyword);
        fetch(url)
            .then(response => response.text())
            .then(data => {
